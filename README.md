...
2) What did you do particularly well in developing this documentation?
  ...
  I was excellent at coding the client server connections in the program and researching the information necessary to finish the project.
...
4) If you could choose one part of your work on these documents to revise, what would you pick? How would you improve it?
  ...
  I wouldn't have any part of the document revised but I do wish that I was quicker to understand the process of creating a software design document because it would have been more efficiently prepared.
5) How did you interpret the user’s needs and implement them into your software design? Why is it so important to consider the user’s needs when designing?

  I interpreted the user's by prioritizing the instructions of the project and coding based on those instructions.  It is important to consider the user's needs when designing because our view on what is needed can be completely different from the user's needs.
